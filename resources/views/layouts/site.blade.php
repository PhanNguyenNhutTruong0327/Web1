...
<body>
                ...
                <div class="row ">
                    <div class="col-md-4 col-sm-12">
                        <a class="navbar-brand" href="#">
                            <img style="width: 150px;" src="./assets/image/logo.png" alt="Logo">
                        </a>
    ...
    <footer class="text-white" style="background-color: #12225b;">
        <div class="container">
            <div class="row pt-3">
                <div class=" col-sm-3">
                    <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <h5 className="footer text-center">N.Truong STORE</h5>
                ...
                <div class="col-sm-3">
                    <div className="col-md-5 col-lg-5 col-xl-3 mx-auto mb-2 text-white">
                        ...
                        <p><a href="" className="text-reset " style="color: white">Trang chủ</a></p>
                        <p><a href="" className="text-reset " style="color: white">Sản phẩm</a></p>
                        <p><a href="" className="text-reset " style="color: white">Danh mục sản phẩm</a></p>
                        <p><a href="" className="text-reset " style="color: white">Thương hiệu sản phẩm</a></p>
                        <p><a href="" className="text-reset " style="color: white">Thông tin liên hệ</a></p>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div className="col-md-3 col-lg-3 col-xl-3mx-auto mb-3 ">
                        ...
                        <p><a href="" className="text-reset " style="color: white">Giới thiệu</a></p>
                        <p><a href="" className="text-reset " style="color: white">Chính sách mua hàng</a></p>
                        <p><a href="" className="text-reset " style="color: white">Chính sách bảo hành</a></p>
                        <p><a href="" className="text-reset " style="color: white">Chính sách vận chuyển</a>
                        </p>
                        <p><a href="" className="text-reset " style="color: white">Điều khoản đổi trả</a></p>
                    </div>
                </div>
                <div class="col-sm-3">
        ...
        <hr>
        <h6 class="text-center"> N.Truong Store - Phan Nguyễn Nhựt Trường - 2121110327</h6>
        <br>
    </footer>
